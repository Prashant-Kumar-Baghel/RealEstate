...
const BlogItemThree = ({blogItem}) => {
    ...
    const { setBlogData, currentMonthName} = useContext(myContext); 
    ...
    return (
        <div className="blog-item">
            ...
            <div className="blog-item__content bg-white border-0 p-4">
                ...
                {/* Button */}
                <button 
                className='rounded-[5px] border-[1px] border-solid border-gray-400 font-[500] text-[1rem] uppercase px-[30px] py-[18px] bg-white  text-gray-600 hover:bg-gray-400 '>Read More <FontAwesomeIcon icon={faArrowRight} size="lg" color="gray-600" className="custom-class" /></button>
